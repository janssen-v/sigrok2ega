...
#define IMG_WIDTH 460
#define IMG_HEIGHT 290
...
inline void pset(SDL_Surface *surface, unsigned int x, unsigned int y, unsigned char color) {
...
int WinMain() {
  ...
  unsigned int x = 0;
  unsigned int y = 0;
  const int sclk = 16000000; // 24->16MHz
  //int pclk = 7155140;
  //int pclk = 14356180;
  int pclk = 16065000;
  int phase = 222900;
